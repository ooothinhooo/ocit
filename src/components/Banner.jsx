...
export default function Banner({ title, desc, ImagePhoto }) {
    return (
        <div className="w-full">
            <section class="py-8">
                <div class="container px-4 mx-auto">
                    <div class="px-7 py-6 bg-indigo-800 rounded-md">
                        <div class="flex flex-wrap">
                            <div class="w-full md:w-1/2 pt-6 mb-10 md:mb-0">
                                <h3 class="mb-1 text-2xl font-bold text-white">
                                    <span class="text-green-300">{title}</span>
                                    <span></span>
                                </h3>
                                <p class="mb-8 md:mb-16 text-sm font-medium text-indigo-100">{desc}</p>
