...
function Footer() {
    ...
    const FB = 'https://www.facebook.com/ooothinhooo.io';
    const GITHUB = 'https://github.com/ooothinhooo';
    const TW = '#';
    const DISCORD = '#';
    return (
        <AnimatePresence>
            <motion.footer
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                class="w-full my-6 p-4 bg-primary text-white sm:p-6 "
            >
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul class=" ">
                                ...
                                <li>
                                    <a href={DISCORD} class="hover:underline">
                                        Discord
                                    </a>
                                </li>
                            </ul>
